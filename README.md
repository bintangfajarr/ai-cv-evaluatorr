...
- [Job Description Management](#job-description-management)
  - [Get All Job Descriptions](#get-all-job-descriptions)
  - [Get Job Description by ID](#get-job-description-by-id)
  - [Get Default Job Description](#get-default-job-description)
  - [Create Job Description](#create-job-description)
  - [Update Job Description](#update-job-description)
  - [Set Default Job Description](#set-default-job-description)
...
Mendapatkan daftar semua job descriptions.
...
Mendapatkan detail job description spesifik.

- **Metode**: GET
- **URL**: `/job-description/:id`
- **Headers**: `Authorization: Bearer <token>`
- **URL Parameter**: `id` = Job Description ID
...
- Jika job description tidak ditemukan, server akan mengembalikan respons:
  - **Status Code**: 404
  - **Response Body**:
  ```json
  {
...
Mendapatkan job description default untuk evaluasi.

- **Metode**: GET
- **URL**: `/job-description/default`
- **Headers**: `Authorization: Bearer <token>`
...
- Jika tidak ada default job description, server akan mengembalikan respons:
  - **Status Code**: 404
  - **Response Body**:
  ```json
  {
    "success": false,
    "message": "No default job description found"
  }
  ```
...
- Jika job description berhasil dibuat, server akan mengembalikan respons:
  - **Status Code**: 201
  - **Response Body**:
  ```json
  {
...
**Side Effects:**
- Otomatis generate embeddings untuk RAG
- Tersimpan di ChromaDB vector database

---

### Update Job Description

Mengupdate job description yang sudah ada.
...
- Update di ChromaDB vector database

---

### Set Default Job Description

Mengatur job description sebagai default.

- **Metode**: POST
- **URL**: `/job-description/:id/set-default`
- **Headers**: `Authorization: Bearer <token>`
- **URL Parameter**: `id` = Job Description ID

- Jika berhasil, server akan mengembalikan respons:
  - **Status Code**: 200
  - **Response Body**:
  ```json
  {
    "success": true,
    "message": "Job description set as default"
  }
  ```
...
**Side Effects:**
- Unset default pada job description lainnya
- Job description ini akan digunakan untuk evaluasi baru

---

### Toggle Active Status

Mengubah status aktif job description.

- **Metode**: PATCH
- **URL**: `/job-description/:id/toggle-active`
- **Headers**: 
  - `Authorization: Bearer <token>`
  - `Content-Type: application/json`
- **URL Parameter**: `id` = Job Description ID
